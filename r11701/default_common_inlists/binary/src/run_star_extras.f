...
! set VARCONTROL: for massive stars, turn up varcontrol gradually to help them evolve
  ...
  !al. 2011 value at 8 Msun
    ...
    s% overshoot_f_above_nonburn_shell = 0.0d0
    s% overshoot_f_below_nonburn_shell = 0.0d0
    s% overshoot_f_above_burn_h_shell  = 0.0d0
    s% overshoot_f_below_burn_h_shell  = 0.0d0
    s% overshoot_f_above_burn_he_shell = 0.0d0
    s% overshoot_f_below_burn_he_shell = 0.0d0
    s% overshoot_f_above_burn_z_shell  = 0.0d0
    s% overshoot_f_below_burn_z_shell  = 0.0d0
    ...
    s% overshoot_f0_above_nonburn_shell = 0.0d0
    s% overshoot_f0_below_nonburn_shell = 0.0d0
    s% overshoot_f0_above_burn_h_shell  = 0.0d0
    s% overshoot_f0_below_burn_h_shell  = 0.0d0
    s% overshoot_f0_above_burn_he_shell = 0.0d0
    s% overshoot_f0_below_burn_he_shell = 0.0d0
    s% overshoot_f0_below_burn_z_shell  = 0.0d0
    s% overshoot_f0_above_burn_z_shell  = 0.0d0
    ...
    subroutine eval_wind_for_scheme(scheme,wind)
      ...
      if(s% x_logical_ctrl(3)) then ! Belczynski+2010 LBV2 winds (eq. 8) with factor 1
        if ((s% center_h1 < 1.0d-4) ) then  ! postMS
            if ((s% L1/Lsun > 6.0d5) .and. & sfsdfsdfsf
